...
![diagram](https://linkliu.github.io/game-tech-post/assets/img/shader_book/diagram71.png){:  .shadow width = "90%" }   
...
- **始前准备**   
  ...
  ![diagram](https://linkliu.github.io/game-tech-post/assets/img/shader_book/diagram72.png){:  .shadow width = "90%" }   
